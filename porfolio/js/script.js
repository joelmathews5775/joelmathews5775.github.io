...
aboutLinkButton.addEventListener('focus', () => {
  aboutLinkButton.parentNode.classList.add('css-about-link-active-background');
}); 
aboutLinkButton.addEventListener('blur', () => {
  aboutLinkButton.parentNode.classList.remove('css-about-link-active-background');
});
...
contactLinkButton.addEventListener('focus', () => {
  contactLinkButton.parentNode.classList.add('css-contact-link-active-background');
  contactLinkButton.classList.add('css-contact-active-link'); 
}); 
contactLinkButton.addEventListener('blur', () => {
  contactLinkButton.parentNode.classList.remove('css-contact-link-active-background');
...
const resumeLinkButton = document.querySelector('.css-download-link');
resumeLinkButton.addEventListener('focus', () => {
  resumeLinkButton.parentNode.classList.add('css-download-link-active-background');
}); 
resumeLinkButton.addEventListener('blur', () => {
  resumeLinkButton.parentNode.classList.remove('css-download-link-active-background');
});
