...
export function initFullHeightListener () {
  setFullHeight();
...
export function displayProjects(projectContainer, projects) {
  let projectHTML = '';
  projects.forEach(project => {
    projectHTML += `
      <div class="project-details-container">
        <div class="project-preview-image-background">
          <img src="${project.thumbnailImgPath}" alt="${project.altText}" class="preview-image">
        </div>
        <div class="project-details">
          <h3 class="heading3 project-main-sub-heading">${project.name}</h3>
          <p class="paragraph project-main-sub-paragraph">${project.description}</p>
          <div class="link-buttons projects-link-buttons">
            <div class="link-button-background preview-link-background">
              <a href="${project.previewLink}" class="preview-link">
                <picture class="picture">
                  <source srcset="img/live_preview_22x22_black.svg" type="image/svg+xml" media="(prefers-color-scheme: dark)" class="dark-new-tab-icon">
                  <img src="img/live_preview_22x22_white.svg" alt="Open new tab icon." style="width: 17px; height: 17px;" class="light-new-tab-icon">
                </picture>  
                &nbsp;&nbsp;Live Preview
              </a>
            </div>
            <div class="link-button-background source-link-background">
              <a href="${project.sourceLink}" class="source-link">
                <picture class="picture">
